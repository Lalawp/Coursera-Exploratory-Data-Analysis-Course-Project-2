...
NEI99 <- NEI[which(NEI$year=="1999"), ]
NEI02 <- NEI[which(NEI$year=="2002"), ]
NEI05 <- NEI[which(NEI$year=="2005"), ]
NEI08 <- NEI[which(NEI$year=="2008"), ]

##Totals the emissions for each subset
...
plot(NEIMean$Year, NEIMean$PollutantMean, main="Total Emissions", type="l", xlab="Year", ylab="Total Pollutants by Tonne")
